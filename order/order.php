...
?>
        ...
        <div class="float-right">
          <div class=" dropdown mr-4">
            ...
            <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -20px; top: 25px">
              ...
              <a class="dropdown-item" href="./history.php" id="history"><i class="far fa-credit-card"></i> Lịch sử thanh toán</a>
            ...
            <div class="col-lg-4">
              <div class="card bg-dark border-primary">
                <div class="card-header text-white  border-primary">
                  ...
                  <span class="float:right"><a class="btn btn-primary btn-sm col-sm-3 float-right" style="right:-10px" href="./index.php" id="">
                ...
                <div class="card-body">
                  ...
                  ?>
                    <button class="btn btn-primary btn-sm delete_order" type="submit" data-id="<?php echo $MaOrder ?>">
                      <form action="./delete.php" id="delete_form" method="POST"><input type="hidden" name="ma_order_del" value="<?php echo $MaOrder ?>"></form>Xóa Order
                    </button>
                  <?php
                  }
                  ?>
  ...
  <script>
    ...
    $('#prod-list .prod-item').click(function() {
      ...
      tr.append('<td class="text-right"><input type="hidden" name="price[]" id="" value="' + data.DonGia + '"><input type="hidden" name="amount[]" id="" value="' + data.DonGia + '"><span class="amount">' + (parseInt(data.DonGia).toLocaleString("en-US", {
        style: 'decimal',
    ...
    function calc() {
      $('[name="qty[]"]').each(function() {
        $(this).change(function() {
          ...
          tr.find('.amount').text(parseInt(amount).toLocaleString("en-US", {
            style: 'decimal',
            minimumFractionDigits: 0,
            maximumFractionDigits: 0
          }))
    ...
    $("#pay").click(function() {
      ...
      $('#apayable').val(parseInt(amount).toLocaleString("en-US", {
        style: 'decimal',
        minimumFractionDigits: 0,
        maximumFractionDigits: 0
      }))
      ...
      $('#change').val(parseInt(change).toLocaleString("en-US", {
        style: 'decimal',
        minimumFractionDigits: 0,
        maximumFractionDigits: 0
      }))
